...
{{--                        </div>--}}
{{--                    @endif--}}
                    <form name="sentMessage" action="{{route('products.store')}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                        @csrf
                        <div class="control-group">
                            <label><h4>Bizga maxsulotingiz haqida gapirib bering</h4></label>
                            <label>Maxsulotingiz nomi*</label>
                            <input type="text" class="form-control" name="nomi" value="{{old('nomi')}}" placeholder="Masalan: Onalar uchun buket"
                        ...
                        <div class="control-group">
                            ...
                            <input type="number" class="form-control" name="narxi" value="{{old('narxi')}}" placeholder=""
                        ...
                        <div class="control-group">
                            ...
                            <textarea class="form-control"  rows="6" name="tasnifi"
                                      ...
                                      required="required"
                                      data-validation-required-message="Maxsulotingizni tasnifini kiriting!">{{old('tasnifi')}}</textarea>
